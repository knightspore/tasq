<template>
    <div class="min-h-screen bg-gray-200 text-gray-900">
        <nav class="bg-gray-900 border-b border-gray-100">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden shadow-md">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="flex items-center px-4">
                        ...
                        <div class="ml-3">
                            <div class="font-medium text-base text-gray-50">{{ $page.user.name }}</div>
