<template>
    <div class="w-auto shadow-md flex bg-purple-100">
        <div class="my-auto h-full p-2 text-gray-500 hover:text-gray-700">
        ...
        <input class="px-2 text-gray-500 w-full" type="text" name="search" placeholder="Search Tasks...">
    </div>
</template>
