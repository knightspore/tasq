...
<div class="card m-2 text-center">
        ...
        <img class="card-img-top rounded-circle img-thumbnail mb-3" src="{{ $user->avatar }}" alt="{{ $user->name }}">
            ...
            <p class="card-text"><small class="text-muted"><a href="slack://user?team=T8WB0LBLJ&id={{ $user->slack_id }}">Slack</a> | <a href="mailto:{{ $user->email }}">Email</a> |
                    <a href="https://app.asana.com/0/{{ $user->asana_id }}/list" target="_blank">Asana</a> </small></p>
        </div>
</div>
